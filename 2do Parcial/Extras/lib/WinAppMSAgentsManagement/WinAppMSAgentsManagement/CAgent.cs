...
namespace WinAppMSAgentsManagement
{
    class CAgent
    {
        ...
        public void Palabra(Form ObjForm)
        {
            ...
            mMSAgent.Characters[mName].Speak(lineSpa, null);
            mMSAgent.Characters[mName].Speak(lineEng, null); //corregir que pronuncie en ingles
            Thread.Sleep(10000);
            Application.Exit();
        }
        public void Ingreso(Form ObjForm)
        {
            ...
            mMSAgent.Characters[mName].Speak("Bienvenido al Traductor.", null);
            Thread.Sleep(10000);
            Application.Exit();
        }
        ...
        public void Salida(Form ObjForm)
        {
            mMSAgent.Characters[mName].Balloon.Style = 7;
            mMSAgent.Characters[mName].Play("Wave");
            mMSAgent.Characters[mName].Speak("Gracias por utilizar el traductor.", null);
