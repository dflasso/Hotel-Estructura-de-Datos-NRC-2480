...
int main(int argc, char** argv) {
	...
	char *opciones[]={"1) Juego.","2) Imagen.","3) Consulta PDF.","4) Codigo QR.","5) Ayuda o PULSE \"F1\".","6) Backup.","7) Base de Datos (Mongo).","8) Salir / Exit."};
	...
	do
	{
		...
		switch(opcion)
		{
			case 1:
				...
				{
					flagGame=true;
					opcionJuego=menu("Juego",opcionesJuego,3);
					system("cls");
					switch(opcionJuego)
					{
						case 1:
